...
const strecken = [
    {
        ...
        track: require('./strecken/strecke01.json'),
    },
    {
        name: '1',
        lookupIndex: '01',
    ...
    },
    {
        ...
        track: require('./strecken/strecke02.json'),
    },
    {
        name: '3',
        lookupIndex: '03',
        ...
        track: require('./strecken/strecke03.json'),
    },
    {
        name: '4',
        lookupIndex: '04',
        ...
        track: require('./strecken/strecke04.json'),
    },
    {
        name: '5',
        lookupIndex: '05',
        ...
        track: require('./strecken/strecke05.json'),
    },
    {
        name: '6',
        lookupIndex: '06',
        ...
        track: require('./strecken/strecke06.json'),
    },
    {
        name: '7',
        lookupIndex: '07',
        ...
        track: require('./strecken/strecke07.json'),
    },
    {
        name: '8',
        lookupIndex: '08',
        ...
        track: require('./strecken/strecke08.json'),
    },
    {
        name: '9',
        lookupIndex: '09',
        ...
        track: require('./strecken/strecke09.json'),
    },
    {
        name: '10',
        lookupIndex: '10',
        ...
        track: require('./strecken/strecke10.json'),
    },
    {
        name: '11',
        lookupIndex: '11',
        ...
        track: require('./strecken/strecke11.json'),
    },
    {
        name: '12',
        lookupIndex: '12',
        ...
        track: require('./strecken/strecke12.json'),
    },
    {
        name: '13',
        lookupIndex: '13',
        ...
        track: require('./strecken/strecke13.json'),
    },
    {
        name: '14',
        lookupIndex: '14',
...
const addTimesToStrecken = strecken => {
    strecken[0].timeOffset = 0;

    strecken.slice(1).forEach((strecke, index) => {
        if ('newStart' in strecke) {
            strecke.timeOffset = strecke.newStart;
        } else {
            strecke.timeOffset = strecken[index].timeOffset + strecke.pace * strecke.distance / 1000;
        }
    })
    return strecken;
}
